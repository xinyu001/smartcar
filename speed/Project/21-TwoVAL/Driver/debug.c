...
extern float AD_val_1_min,AD_val_2_min,AD_val_3_min,AD_val_4_min,AD_val_5_min,AD_val_6_min;
extern float AD_val_1_max,AD_val_2_max,AD_val_3_max,AD_val_4_max,AD_val_5_max,AD_val_6_max;
...
extern int turn_right_Flag,turn_left_Flag;
...
//    OLED_PrintValueF(72, 3,AverageSpeed,4);  
        OLED_P6x8Str(0,3,"NitroBooster");
    OLED_PrintValueF(72, 3,NitroBooster,4);  
...
//    OLED_PrintValueF(72, 3,MotorOut,4);  
    ...
    OLED_P6x8Str(0,6,"MotorOut");
    OLED_PrintValueF(72, 6,MotorOut,4);
...
//    OLED_PrintValueF(72, 6,Middle_Err,4);
    OLED_P6x8Str(0,6,"v5:");
    OLED_PrintValueF(30, 6,dis_AD_val_5,4);
    OLED_PrintValueF(80, 6,disgy_AD_val_5,4);
    OLED_P6x8Str(0,7,"v6:");
    OLED_PrintValueF(30, 7,dis_AD_val_6,4);
    OLED_PrintValueF(80, 7,disgy_AD_val_6,4);
    OLED_Set_Pos(122,7);
  ...
  ///////////////////////////////第五页 显示数据
    ...
    OLED_P6x8Str(0,6,"v5:");
    OLED_PrintValueF(30, 6,AD_val_5_min,4);
    OLED_PrintValueF(70, 6,AD_val_5_max,4);
    OLED_P6x8Str(0,7,"v6:");
    OLED_PrintValueF(30, 7,AD_val_6_min,4);  
    OLED_PrintValueF(70, 7,AD_val_6_max,4);
...
//    OLED_PrintValueF(0, 1,LMR[0][1],4);
//    OLED_PrintValueF(0, 2,LMR[0][2],4);
//    OLED_PrintValueF(0, 3,LMR[0][3],4);
//    OLED_PrintValueF(0, 4,LMR[0][4],4);
//    OLED_PrintValueF(0, 5,LMR[0][5],4);
//    OLED_PrintValueF(0, 6,LMR[0][6],4);
//    OLED_PrintValueF(0, 7,LMR[0][7],4);
//    
//    OLED_PrintValueF(36, 1,LMR[0][8],4);
//    OLED_PrintValueF(36, 2,LMR[0][9],4);
//    OLED_PrintValueF(36, 3,LMR[0][10],4);
//    OLED_PrintValueF(36, 4,LMR[0][11],4);
//    OLED_PrintValueF(36, 5,LMR[2][1],4);
//    OLED_PrintValueF(36, 6,LMR[2][2],4);
//    OLED_PrintValueF(36, 7,LMR[2][3],4);
//    
//    OLED_PrintValueF(72, 1,LMR[2][4],4);
//    OLED_PrintValueF(72, 2,LMR[2][5],4);
//    OLED_PrintValueF(72, 3,LMR[2][6],4);
//    OLED_PrintValueF(72, 4,LMR[2][7],4);
//    OLED_PrintValueF(72, 5,LMR[2][8],4);
//    OLED_PrintValueF(72, 6,LMR[2][9],4);
