...
//    if(ABS(disgy_AD_val_2-disgy_AD_val_1)>70){
//    Middle_Err=disgy_AD_val_2-disgy_AD_val_1;
//    }
//    else{
...
//    }
  ...
  if(ABS(err)<50&&circle_Flag==1&&turn_Flag==0 && Inductor_ADC[0]>20 && Inductor_ADC[1]>20)
  {
     turn_Flag=1;                               //进入圆环
 ...
 if(RoadType==115 && Distance-Distance114>1.5){
  ...
  //右环
  if(RoadType==101 && Distance-Distance101>2){                
  ...
  if(RoadType==103 && Distance-Distance102>6){
  ...
  if(RoadType==104 && Distance-Distance104>1.3){
  
    RoadType=105;              //出右环
    Distance105=Distance;  
    
  }
 if(RoadType==105 && Distance-Distance105>1.5){
